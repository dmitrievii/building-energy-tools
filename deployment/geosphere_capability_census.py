...
def main() -> int:
    ...
    report = {
        ...
        "quality_flags_not_consumed_by_adapter": flags,
    ...
    lines.extend(["", "## Quality flags", "", f"The live resource exposes {len(flags)} `*_flag` fields; the current adapter does not consume them.", ""])
